...
def get_vector_functions(mesh):
    ...
    vector_element = basix.ufl.element(family="Lagrange", cell=str(mesh.ufl_cell()), degree=2, shape=(mesh.geometry.dim, ))
...
def get_tensor_functions(mesh, f=None, shape = (3,3)):
    ...
    if shape is (1,1):
        ...
        tensor_field = dolfinx.fem.functionspace(mesh, basix.ufl.element(family="CG", cell=str(mesh.ufl_cell()), degree=1, shape=shape))
