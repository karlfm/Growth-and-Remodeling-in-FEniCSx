...
F_g_prev_function, F_g_prev_expression, mandel_stress_function, F_e = gl.GCG(mesh, F)
...
mandel_stress_expression = dolfinx.fem.Expression(F_e.T*P, tensor_space.element.interpolation_points())
...
for i in range(0, N+1):
    ...
    mandel_stress_function.interpolate(mandel_stress_expression)                # Update elastic deformation tensor
...
with open("../Plots/10p_stretch_crossfiber_GCG.json", "w") as f:
    json.dump(data_to_save, f)

# Load data from JSON file
with open("../Plots/10p_stretch_crossfiber_GCG.json", "r") as f:
...
# Save the figure
plt.savefig('../Plots/10p_stretch_crossfiber_GCG.png', dpi=300, bbox_inches='tight')
plt.close()

print("Plot saved as 10p_stretch_crossfiber_GCG.png")