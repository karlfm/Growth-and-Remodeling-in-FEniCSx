...
F_g_prev_function, F_g_prev_expression, E_e_function, E_e_expression, F_e = gl.GEG(mesh, F)
...
us = []; F_g_f_prev = []; F_g_c_prev = []; F_e_f = []; F_e_c = [] 
'''Solve The Problem'''
...
with open("../Plots/10p_stretch_crossfiber_GEG.json", "w") as f:
    json.dump(data_to_save, f)

# Load data from JSON file
with open("../Plots/10p_stretch_crossfiber_GEG.json", "r") as f:
...
# Save the figure
plt.savefig('../Plots/10p_stretch_crossfiber_GEG.png', dpi=300, bbox_inches='tight')
plt.close()

print("Plot saved as 10p_stretch_crossfiber_GEG.png")