...
mandel_stress_expression = dolfinx.fem.Expression(
    F_e.T * P, tensor_space.element.interpolation_points()
)
...
for i in range(0, N + 1):
    ...
    mandel_stress_function.interpolate(
        mandel_stress_expression
